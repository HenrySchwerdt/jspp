...
export class BSFileNotFoundException extends BSException {
    ...
    print(): void {
        ...
        console.log()
        console.log(colors.red(" -   Please consider checking your directory or file and run this command again."))
    }
...
export class BSParseException extends BSException {
    ...
    print(): void {
        ...
        console.log(colors.cyan(number+'\t') + colors.magenta(this.falsyToken.position.line))
        console.log(colors.red(number.replace(/./g, " ")  + (new Array(4 + this.falsyToken.position.col + this.falsyToken.value.length)).fill('-').join('') + '^'))
    }
...
export class BSLexException extends BSException {
    ...
    print() {
        ...
        console.log(colors.cyan(number+'\t') + colors.magenta(this.errorToken.position.line))
        console.log(colors.red(number.replace(/./g, " ")  + (new Array(4 + this.errorToken.position.col)).fill('-').join('') + '^'))
    }
}